...
import { 
  User, LogOut, Mail, ShieldCheck, Copy, Check 
} from 'lucide-react';
  ...
  return (
    <div className="flex-1 p-6 lg:p-8 overflow-y-auto h-full">
      <div className="mb-8">
        ...
        <p className="text-[#667085] mt-1">Manage your account settings and preferences.</p>
      </div>
        ...
        <div className="space-y-6 max-w-3xl">
          <div className="bg-white rounded-xl border border-[#e5e7eb] overflow-hidden">
            <div className="p-6 border-b border-[#e5e7eb]">
              ...
              <p className="text-sm text-[#667085] mt-1">Update your photo and personal details here.</p>
            </div>
            
            <div className="p-6 space-y-6">
              <div className="flex items-center gap-6">
                <div className="h-20 w-20 rounded-full bg-[#7f56d9] flex items-center justify-center text-white text-2xl font-bold">
                  {formData.name?.[0] || 'A'}
                </div>
                <button className="px-4 py-2 text-sm font-semibold text-[#7f56d9] border border-[#7f56d9] rounded-lg hover:bg-[#f4ebff] transition-colors">
                  Change photo
                </button>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-[#344054] mb-2">Role</label>
          ...
          <div className="bg-white rounded-xl border border-[#e5e7eb] overflow-hidden">
            <div className="p-6 border-b border-[#e5e7eb]">
              ...
              <p className="text-sm text-[#667085] mt-1">Details about your hospitality establishment.</p>
            </div>
            
            <div className="p-6 space-y-6">
              <div>
                <label className="block text-sm font-medium text-[#344054] mb-2">Property ID</label>
                <p className="text-xs text-[#667085] mb-2">Unique identifier for your property.</p>
              ...
              <div>
                <label className="block text-sm font-medium text-[#344054] mb-2">Public Status</label>
                <p className="text-xs text-[#667085] mb-3">Allow guests to find your property.</p>
                <button className="relative w-12 h-6 bg-[#7f56d9] rounded-full transition-colors">
          ...
          <div className="bg-white rounded-xl border border-red-200 overflow-hidden">
            <div className="p-6 border-b border-red-100 bg-red-50/50">
              ...
              <p className="text-sm text-red-600 mt-1">Actions that cannot be undone.</p>
            </div>
            <div className="p-6 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-[#101828]">Sign out from all devices</h3>
                <p className="text-sm text-[#667085]">This will end your current session.</p>
              </div>
              <button 
